...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Users</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/List Of User</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="col-sm-1 col-md-2">
                    @can('add user')
                        <a class="btn btn-primary btn-sm" href="{{ route('users.create') }}">add</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
