...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ List Of Invoices</span>
						</div>
					</div>
...
@endif
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								data-effect="effect-scale" href="invoices/create">Add Of Invoice</a>
								@endcan

								<br>
								@can('export Excel')
								<a class="modal-effect btn  btn-primary" href="{{ url('exportinv') }}"
	...
	@can('edit')	
	<a class="dropdown-item" href="{{url('edit_envoices')}}/{{$inv->id}}">
			<i class="text-primary fas fa-pen-alt"></i>&nbsp;&nbsp;edit</a>
			@endcan
			@can('delete')
		<a class="dropdown-item" href="#" data-invoice_id="{{ $inv->id }}"
															...
															</i>&nbsp;&nbsp;invoices archive</a>
	
	
															@endcan

																<a class="dropdown-item" href="print/{{ $inv->id }}"><i
                                                                class="text-success fas fa-print"></i>&nbsp;&nbsp;print_invoice                                                        </a>
    ...
    Are You sure delete invoice ?
		...
		<div class="modal" id="Transfer_invoice">
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">deleteOf invoice</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button">
							<span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
					<form action="{{url('invoices/destroy')}}" method="POST">
