                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" class="form-control" id="id" name="invoices_id" value="{{$invoice->id}}">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="please enter number of invoices" value="{{$invoice->invoices_number}}" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" value="{{$invoice->Amount_commision}} " class="form-control form-control-lg" id="Amount_Commission"
                            ...
                            <div class="col">
                                ...
                                <input type="text" value="{{$invoice->discount}} "  class="form-control form-control-lg" id="Discount" 
                                name="Discount"
