...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ invoices_report</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="rdio" type="radio" value="1" id="type_div"> <span>search of date</span></label>
                    </div>


                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>
                            search of number invoices
                            </span></label>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">selecte of invoices</p><select class="form-control select2" name="type"
                                required>
                                <option value="{{ $type ?? 'selecte of invoices' }}" selected>
                                    {{ $type ?? 'selecte of invoices' }}
                                </option>

                                <option value="paid">pain</option>
                                <option value="not pain">notpain</option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            <p class="mg-b-10">  search of number invoices</p>
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{url('invoicesdatails')}}/{{$invoice->id}}" >{{$invoice->sections->section_name}}</a></td>
