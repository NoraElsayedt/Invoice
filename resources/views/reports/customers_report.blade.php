...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ report of User</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                <!--placeholder-->
                                <option value="" selected disabled>select of section</option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label for="inputName" class="control-label">produect</label>
